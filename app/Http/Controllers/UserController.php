...
class UserController extends Controller
{
    ...
    {
        $users = User::all();
        return view('super_user.referensi.daftarPengguna.index', compact('users'));
    }
    ...
    {
        return view('super_user.referensi.daftarPengguna.create');
    }
    ...
    public function edit($user_id)
    {
        ...
        return view('super_user.referensi.daftarPengguna.edit', compact('user'));
    }
