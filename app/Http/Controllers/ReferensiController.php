...
class ReferensiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super_user.referensi.jenisBarang.index', compact('jenisBarang'));
    }
    ...
    {
        return view('super_user.referensi.jenisBarang.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('super_user.referensi.jenisBarang.edit', compact('jenisBarang'));
    }
